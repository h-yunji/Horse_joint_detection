...
auto_scale_lr = dict(base_batch_size=512) # 수정
...
data_mode = 'topdown'
data_root = 'data/coco_tiny_images' # 요기 수정
...
dataset_coco = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='/RnD/horse/horse_train.json',
        data_prefix=dict(img='/RnD/horse/'),
        pipeline=[],
    ),
    # times=3)
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='/RnD/horse/'), # 수정
        test_mode=True,
...
#         data_root=data_root,
#         data_mode=data_mode,
#         ann_file='/RnD/mmpose/animal_test.json',
#         # bbox_file='data/coco/person_detection_results/'
#         # 'COCO_val2017_detections_AP_H_56_person.json',
#         data_prefix=dict(img='/RnD/mmpose/test'), # 수정
#         test_mode=True,
#         pipeline=val_pipeline,
#     ))
...
# val_evaluator = dict(
#     type=CocoMetric,
#     ann_file=data_root + '/RnD/mmpose/animal_val.json') # 수정
